      ...
      <div className="md:w-3/4 p-3">
        ...
        <div className="flex flex-wrap">
          {genres?.map((genre) => (
            <div key={genre._id}>
              <button
                className="bg-white border border-blue-600 text-blue-600 py-2 px-4 rounded-lg m-3 hover:bg-blue-600 hover:text-white focus:outline-none focus:ring-2 focus:ring-teal-500 focus:ring-opacity-50"
                onClick={() => {
                  {
